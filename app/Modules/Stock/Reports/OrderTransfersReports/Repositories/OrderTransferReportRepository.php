        ...
        $sql = "
            ...
            FROM (
                ...
                FROM (
                    ...
                    LEFT JOIN inventory_transactions AS it_out ON it_out.source_transaction_id = it_in.id AND it_out.movement_type = 'out' AND it_out.store_id = it_in.store_id AND it_out.deleted_at IS NULL AND (? IS NULL OR it_out.movement_date <= ?) AND it_out.transactionable_type IN ('App\\\\Models\\\\ReturnedOrder', 'App\\\\Models\\\\StockTransferOrder')
