 ...
 */
if (!function_exists('getSumQtyOfProductFromPurchases')) {
 ...
 */
if (!function_exists('getSumQtyOfProductFromOrders')) {
 ...
 */
if (!function_exists('comparePurchasedWithOrderdQties')) {
 ...
 */
if (!function_exists('calculateFifoMethod')) {
 ...
 */
if (!function_exists('calculateIfAlreadyQtyBiggerThanRemaning')) {
 ...
 */
if (!function_exists('fixResultOfCalculating')) {
 ...
 */
if (!function_exists('isOrderCompletedIfQtyLessThanZero')) {
 ...
 */
if (!function_exists('handlePendingOrderDetails')) {
 ...
 */
if (!function_exists('getProductPriceByProductUnitPurchaseInvoiceId')) {
...
if (!function_exists('getProductQuantities')) {
