...
if (!function_exists('checkForMonthlyBalanceAndCreateToCancelAbsent')) {
...
if (!function_exists('calculateAutoWeeklyLeaveData')) {
    function calculateAutoWeeklyLeaveData($yearAndMonth, $employeeId)
    {
        ...
        $absentDays += $absendCalculated['total_no_period_days'];
...
if (!function_exists('calculateAutoWeeklyLeaveDataForBranch_')) {
