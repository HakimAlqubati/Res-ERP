...
use App\Observers\ServiceRequestCommentObserver;

#[ObservedBy(ServiceRequestCommentObserver::class)]
class ServiceRequestComment extends Model implements HasMedia
{
