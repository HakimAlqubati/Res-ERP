...
class AllowancePolicy
{
    ...
    {
        return $user->can('force_delete_allowance');
    }
    ...
    {
        return $user->can('force_delete_any_allowance');
    }
    ...
    {
        return $user->can('restore_allowance');
    }
    ...
    {
        return $user->can('restore_any_allowance');
    }
    ...
    {
        return $user->can('replicate_allowance');
    }
    ...
    {
        return $user->can('reorder_allowance');
    }
}
