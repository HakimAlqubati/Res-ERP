...
class CreatePurchaseInvoice extends CreateRecord
{
    ...
    protected function beforeCreate(): void
    {
        ...
        \Illuminate\Support\Facades\Log::info('Purchase Invoice beforeCreate:', [
            'data_keys' => array_keys($this->data),
            'units' => $this->data['units'] ?? null,
            'purchaseInvoiceDetails' => $this->data['purchaseInvoiceDetails'] ?? null,
    ...
    {
        $details = $this->data['units'] ?? $this->data['purchaseInvoiceDetails'] ?? [];
        if (empty($details)) {
            return [];
        }
