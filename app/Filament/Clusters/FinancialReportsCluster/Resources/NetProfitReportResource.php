...
use App\Filament\Clusters\FinancialReportsCluster\Resources\NetProfitReportResource\Pages;
...
class NetProfitReportResource extends Resource
{
    protected static ?string $model = FinancialTransaction::class;

    protected static ?string $slug = 'net-profit-report';
    ...
    {
        return __('Net Profit Report');
    }

    public static function getNavigationLabel(): string
    {
        return __('Net Profit');
    }

    public static function getPluralLabel(): ?string
    {
        return __('Net Profit Reports');
    }
    ...
    {
        return [
            'index' => Pages\ListNetProfitReport::route('/'),
        ];
    }
