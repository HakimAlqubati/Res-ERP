                ...
                if (
                    ...
                    $group[] =  NavigationGroup::make(__('menu.supply_and_inventory'))
                        ->items(array_merge(
                            ...
                            (isSuperAdmin() || isSystemManager() || isBranchManager() || isStoreManager() || isSuperVisor()) ?  POSIntegrationCluster::getNavigationItems() : [],
                            ...
                            (isSuperAdmin() || isSystemManager() || isBranchManager() || isStoreManager()) ?  HalalLabelReportResource::getNavigationItems() : [],
                            //  (isSuperAdmin() || isSystemManager() || isBranchManager() || isStoreManager()) ?  ReportOrdersCluster::getNavigationItems(): [], 
                            (isSuperAdmin() || isSystemManager() || isBranchManager() || isStoreManager() || isSuperVisor() || isAccountant()) ?  SupplierCluster::getNavigationItems() : [],
                    ...
                    [
                        NavigationGroup::make(__('menu.financial_system'))
                            ->items(array_merge(
                                ...
                                (isSuperAdmin() || isFinanceManager()) ? FinancialCategoryResource::getNavigationItems() : [],
                                (isSuperAdmin() || isFinanceManager()) ? FinancialTransactionResource::getNavigationItems() : [],
