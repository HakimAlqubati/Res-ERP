...
return [
  ...
  'product_code_manual_helper' => 'مسموح فقط بالأحرف الإنجليزية الكبيرة والأرقام والشرطة (-). لا يمكن أن يبدأ بشرطة ولا يحتوي على مسافات.',
  'product_code_invalid_format' => 'يجب أن يبدأ كود المنتج بحرف إنجليزي كبير أو رقم، ويمكن أن يحتوي فقط على أحرف إنجليزية كبيرة وأرقام وشرطة (-) بدون مسافات.',
  'status_active' => 'نشط',
  ...
  'known_name' => 'اسم الموظف في نظام الHR',
  'known_name_description' => 'للربط مع نظام الـ HR',
  'known_name_hint' => 'يجب أن يكون مطابقاً للاسم في نظام الـ HR',
  'known_name_example' => 'مثال: الاسم الرمزي',
  'gender' => 'الجنس',
  'male' => 'ذكر',
  'female' => 'أنثى',
  ...
  'has_accepted_attendance' => 'لها سجل حضور مقبول',
  'image' => 'الصورة',
...
'current_page_total' => 'المجموع الحالي',
  ...
  'price_change_warning' => 'تغيرت أسعار بعض الأصناف بشكل ملحوظ، يرجى مراجعتها.',
