...
return [
  ...
  'base_currency_help' => 'العملة الأساسية هي العملة المرجعية للنظام. يمكن تعيين عملة أساسية واحدة فقط.',
  'exchange_rate_help' => 'سعر الصرف مقابل العملة الأساسية (1.00 للعملة الأساسية)',
  'us_dollar' => 'الدولار الأمريكي',
  'cash_box_and_bank_cluster' => 'الصناديق والبنوك',

  // ===========================================
  // Bank Accounts
  // ===========================================
  'bank_account_name' => 'اسم الحساب البنكي',
  'bank_account_name_placeholder' => 'مثال: حساب الراجحي التجاري',
  'bank_account_info' => 'معلومات الحساب البنكي',
  'iban' => 'رقم الآيبان (IBAN)',
  'gl_control_account' => 'حساب المراقبة في الدليل المحاسبي',
  'gl_account' => 'الحساب المحاسبي',
  'gl_account_help' => 'هذا الحساب في دليل الحسابات الذي يرتبط به الحساب البنكي (مثل: النقدية في البنوك)',
  'copied' => 'تم النسخ',
  ...
  'cash_box_name_placeholder' => 'مثال: صندوق المعرض الرئيسي',
  'cash_box_info' => 'معلومات الصندوق',
  'keeper' => 'أمين الصندوق',
  'keeper_help' => 'الموظف المسؤول عن حفظ هذا الصندوق',
  'max_limit' => 'الحد الأقصى',
  'max_limit_help' => 'الحد الأقصى المسموح للرصيد في هذا الصندوق (0 = لا يوجد حد)',
  'no_limit' => 'لا يوجد حد',
  ...
  'income_statement_report' => 'تقرير قائمة الدخل',
